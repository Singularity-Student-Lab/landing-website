    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <video
          ...
          src="https://res.cloudinary.com/djtemmctt/video/upload/v1761397840/Game_Development_Video_Generation_la9aoj.mp4"
        />
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-8xl font-black text-white mb-6 font-heading">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-400">Chitra Darshan</span> Lab
            </h1>
